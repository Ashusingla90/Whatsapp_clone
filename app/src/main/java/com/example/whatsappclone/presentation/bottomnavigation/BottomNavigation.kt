            ...
            NavigationBarItem(
                ...
                label = {
                    if (index == selectedItem) {
                        ...
                        Text(text = item.name, fontWeight = FontWeight.Bold, color = Color.DarkGray)
                ...
                icon = {
                    Icon(
                        painter = if (index == selectedItem) painterResource(id = item.selectedIcon) else painterResource(
